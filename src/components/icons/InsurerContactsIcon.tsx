...
import contactsSvg from '@/assets/insurers-contact-icon.svg';

const InsurerContactsIcon: React.FC<SvgIconProps> = (props) => {
...
export default InsurerContactsIcon;
